...
- `peano.func.special`
  - Exposed additional scirs2-special functions: complementary/imaginary error functions, incomplete gamma, Fresnel integrals, elliptic integrals and Jacobi elliptic functions, Kelvin functions, extended Bessel orders, and Gaussian/confluent hypergeometric functions.
- WASM backend (`math-utils`)
  - Upgraded `scirs2-special` to `0.1.0-rc.2` and added OpenBLAS stub for `wasm32-wasip1` builds on Linux hosts.
