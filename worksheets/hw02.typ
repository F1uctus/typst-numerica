...
#let TITLE = "ДЗ.02. Численные методы решения нелинейных уравнений."
...
#let show-newton-plot(
  ...
  let eqs = x.map(x0 => x => calc.clamp((x - x0) * d1f(x0) + f(x0), ..secant-codomain))
  align(
    center,
    cetz.canvas({
      import plot: *
